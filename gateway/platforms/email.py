...
Environment variables:
    ...
    EMAIL_ADDRESS       — Email address for the agent (From: header)
    EMAIL_LOGIN_USER    — IMAP/SMTP login username (defaults to EMAIL_ADDRESS;
                          set this when your login user differs from the
                          public address, e.g. iCloud custom domains)
...
class EmailAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config: PlatformConfig):
        ...
        self._login_user = os.getenv("EMAIL_LOGIN_USER", "") or self._address
