...
_REFERENCE_SYSTEM_PROMPT = (
    ...
    "NOT the acting agent and you do NOT execute anything: tool calls are not "
    "available, you cannot call tools, run commands, browse, or access files, "
    "repositories, or URLs, and you should not try to or apologize for being "
    "unable to. A separate aggregator/orchestrator model holds those "
    "capabilities and will take the actual actions.\n\n"
    "Everything you output is handled as plaintext by the hermes-agent "
    "harness. Any tool_calls you emit are silently discarded and never "
    "executed — they only pollute the aggregator's context window. Do not "
    "generate tool_calls under any circumstances.\n\n"
